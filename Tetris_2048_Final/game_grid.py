...
class GameGrid:
    ...
    def __init__(self, grid_h, grid_w, info_w, game_speed, game_type):
    ...
    def draw_boundaries(self):
        ...
        stddraw.setPenRadius(self.info_line_thickness) # set pen radius for info box boundaries
    ...
    def draw_info(self):
        ...
        # Pause Game button
        stddraw.setPenColor(Color(0, 250, 250))
